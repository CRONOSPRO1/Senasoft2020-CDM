...
<body>
                    ...
                    <div class="card-header bg-dark text-white">
                        <div class="row px-4">
                            ...
                            <!-- <div class="text-right">
                                <a href="crear-ingreso.php" class="btn btn-success">
                                    ✚ Crear ingreso
                                </a>
                            </div> -->
                        </div>
                                ...
                                <tbody id="registros">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:void(0)" onclick="mostarDetalles('<?= $lista['idingreso'] ?>','<?= $lista['nombre'] ?>','<?= $lista['descripcion'] ?>')" data-target="#actualizar" data-toggle="tooltip" data-placement="top" title="Actualizar">
    ...
    <script>
        function mostarDetalles(idingreso, nombre, descripcion) {
            $('#actualizar').modal('show');
            document.getElementById("idingreso").value = idingreso;
            document.getElementById("nombre").value = nombre;
            document.getElementById("descripcion").value = descripcion;
        }
    </script>

    <!-- Actualizar ingreso (Ventana modal) -->

    <div class="modal" tabindex="-1" id="actualizar">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title borde-bottom-diseno">Actualizar ingreso</h5>
                ...
                <form action="" method="POST">
                    <div class="modal-body">
                        <div class="form-group form-inline">
                            <label>Nombre de la ingreso</label>

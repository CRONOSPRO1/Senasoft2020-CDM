    ...
    <header>
        <div class="container-fluid mb-5">
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow" id="barra">
                ...
                <span class="text-secondary">Jose Ramirez</span>

                <div class="mr-auto">
                    <span class="mr-4" id="span-margen"></span>
                    <a href="#" class="text-secondary text-right rounded-circle" id="notificacionesclick">
                    ...
                    <div class="card ventana-notificaciones" id="ventanaNotificaciones" style="display: none;">

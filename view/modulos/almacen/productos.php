...
<head>
    ...
    <title>Productos | Automatización y gestión Multitiendas</title>
</head>
...
<body>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title borde-bottom-diseno">Actualizar producto</h5>
    ...
    <a class="añadir" href="crear_producto">✚</a>

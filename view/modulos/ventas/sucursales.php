...
<head>
    ...
    <title>Sucursales | Automatización y gestión Multitiendas</title>
</head>
    ...
    <header>
        <div class="container-fluid mb-5">
            <nav class="navbar navbar-expand-lg navbar-light bg-white shadow">
                <a class="nav-link" href="#"><img src="<?=base_url?>" alt="Logo" width="100px"></a>
                ...
                <div class="card-header bg-dark text-white">
                    <div class="row px-4">
                        ...
                        <!-- <div class="text-right">
                            <a href="crear-sucursal.php" class="btn btn-success">
                                ✚ Crear sucursal
                            </a>
                        </div> -->
                    </div>
                            ...
                            <tbody id="registros">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" onclick="mostarDetalles('<?= $lista['idsucursal'] ?>','<?= $lista['nombre'] ?>','<?= $lista['direccion'] ?>')" data-target="#actualizar" data-toggle="tooltip" data-placement="top" title="Actualizar">
...
<script>
    function mostarDetalles(idsucursal, nombre, direccion) {
...
<!-- Actualizar sucursal (Ventana modal) -->

<div class="modal" tabindex="-1" id="actualizar">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title borde-bottom-diseno">Actualizar sucursal</h5>
            ...
            <form action="" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group form-inline">
                        ...
                        <input type="text" name="direccion" id="direccion" class="form-control p2 mx-sm-3" required="">
                    </div>
